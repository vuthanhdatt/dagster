...
from dagster_components.core.component_rendering import ScopedField
...
class DbtProjectParams(BaseModel):
    ...
    translator: Optional[DbtNodeTranslatorParams] = ScopedField(
        default=None, required_scope={"node"}
    )
