...
from dagster_dg.utils import json_schema_property_to_click_option, parse_json_option
...
# from the registered copmonent types in the code location. Because the registered component types
...
class GenerateComponentGroup(click.Group):
...
def _create_generate_component_subcommand(
    ...
    @click.command(name=component_key)
