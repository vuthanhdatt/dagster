...
class BaseAssetGraph(ABC, Generic[T_AssetNode]):
    ...
    def bfs_filter_asset_partitions(
        ...
        "AssetGraphSubset",
        Sequence[Tuple["AssetGraphSubset", str]],
    ]:
        """Returns asset partitions within the graph that satisfy supplied criteria.
        ...
        queue = ToposortedPriorityQueue(self, initial_subsets, include_full_execution_set=True)
        ...
        while len(queue) > 0:
            ...
            subset_that_meets_condition, fail_reasons = condition_fn(
                candidate_keys, candidate_subset_value, result
            )
            ...
            for candidate_key in candidate_keys:
                ...
                if not candidate_subset_value.is_empty:
                    ...
                    for child_key in self.get(candidate_key).child_keys:
                        ...
                        unvisited_child_subset = (
                            ...
                            - visited_graph_subset.get_asset_subset(child_key, self)
                        )
